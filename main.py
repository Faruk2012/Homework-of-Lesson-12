...
#         class NotEnoughHealthException(Exception):
...
#         try:
#             if warrior.health <= 0:
#                 raise NotEnoughHealthException("Not enough health to continue! Try again later.")
#         except NotEnoughHealthException as e:
#             print(e)
#             isPlay = False
#             isMenu = False
